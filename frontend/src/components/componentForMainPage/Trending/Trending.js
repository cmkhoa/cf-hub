    ...
    async function load() {
      ...
      try {
        const res = await fetch(
          `${API_ENDPOINTS.blog.posts}?status=published&sort=views&limit=4`
        );
        ...
        if (!cancelled) console.error("Load trending failed", err);
      } finally {
      ...
      <div className="container">
        ...
        {!loading && featuredPost && (
          <div className="featured-trending">
            <Card
              className="featured-trending-card"
              onClick={() =>
              ...
              <Row gutter={[48, 48]} align="middle">
                ...
                >
                  <div className="featured-content">
                    ...
                    <div className="featured-meta">
                      ...
                      <div className="trending-post-date">
                    ...
                    {featuredPost.tags?.length > 0 && (
                      <div className="featured-tags">
                        {featuredPost.tags.slice(0, 4).map((t) => (
                          <Tag key={t._id || t.name} className="trending-tag">
                            {t.name || t}
                          </Tag>
                        ))}
                      </div>
                ...
                >
                  <div className="featured-image">
                    <Image
                      src={
                        featuredPost.coverImageData
                          ? `${API_ENDPOINTS.blog.posts}/${featuredPost._id}/cover`
        ...
        {/* Trending Posts Grid - 3 smaller posts */}
                  ...
                  <Card className="trending-card" hoverable>
                    <div className="trending-card-image">
                      <Image
                        src={
                          post.coverImageData
                            ? `${API_ENDPOINTS.blog.posts}/${post._id}/cover`
                            : "/assets/blank-profile-picture.jpg"
                        }
                        alt={post.title}
                        width={300}
