...
const JobAppTip = () => {
  ...
  const categoryColumns = [
    {
      title: t("JobAppTip.resumeTips"),
      slug: "resume-tips",
      stories: byCategory["resume-tips"],
    },
    {
      title: t("JobAppTip.interviewTips"),
      slug: "interview-tips",
      stories: byCategory["interview-tips"],
    },
    {
      title: t("JobAppTip.technicalTips"),
      slug: "technical-tips", 
