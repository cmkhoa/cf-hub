...
const CareerStories = () => {
  ...
  const categoryColumns = [
    {
      title: t("CareerStories.resumeTips"),
      slug: "resume-tips",
      stories: byCategory["resume-tips"],
    },
    {
      title: t("CareerStories.interviewTips"),
      slug: "interview-tips",
      stories: byCategory["interview-tips"],
    },
    {
      title: t("CareerStories.technicalTips"),
      slug: "technical-tips", 
      ...
      <div className="container">
        <div className="success-story-header">
          <Title level={2} className="success-story-title">
            {t("CareerStories.title")}
          </Title>
          <p className="success-story-subtitle">
            {t("CareerStories.subtitle")}
          </p>
        </div>
        {loading && (
