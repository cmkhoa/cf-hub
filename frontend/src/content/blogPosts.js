// Central blog posts metadata (temporary static dataset)
export const blogPosts = [
  ...
  },
  {
    ...
    excerpt: "Các cách để cải thiện hồ sơ và có những advantage nhỏ khi apply việc.",
  ...
  {
    id: "aitools",
    title: "CHATGPT 4.0 VS GEMINI ADVANCED: Đâu là sự lựa chọn hoàn hảo cho bạn?",
  ...
  },
  {
    ...
    excerpt: "Làm thế nào để sinh viên năm nhất và năm hai cưa đổ kỳ thực tập mùa hè.",
